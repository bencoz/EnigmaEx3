...
public interface EnigmaMachine {
    ...
    /**
     * creates a Machine.Secret object, that will hold all relevant configuration for the machine to encrypt\decrypt data
     * Machine.Secret object is immutable, and constructed using a builder
     * @return a Builder.SecretBuilder object, using it to build and construct the actual Machine.Secret objec
     */
    SecretBuilder createSecret();

    /**
     * gets the current Machine.Secret object used by this machine instance
     * @return the Machine.Secret object
     */
    Secret getSecret();

    /**
     * configure this machine instance to use the current Machine.Secret
     ...
     * this method also updates the current Machine.Secret object used inside the machine.
    ...
    /**
     * process String of characters in the machine, using the current configured Machine.Secret
    ...
    /**
     * processes a signle character in the machine, using the current configured Machine.Secret
