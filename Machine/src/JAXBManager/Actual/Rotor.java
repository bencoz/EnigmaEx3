...
public class Rotor implements Serializable {
    private List<JAXBManager.Actual.Mapping> mapping;
    private int notch;
    private int id;
    ...
    public void addMappingList(List<JAXBManager.JAXBGenerated.Mapping> mapList) {
        for (JAXBManager.JAXBGenerated.Mapping map : mapList) {
    ...
    public String getMappingABC()
    {
        ...
        String ch ;
        for(JAXBManager.Actual.Mapping map : mapping)
        {
