...
public class Reflector implements Serializable {
    ...
    private List<JAXBManager.Actual.Reflect> reflect;
    private String id;
    private int numID;
    ...
    public List<Integer> getReflectorMapping()
    {
        ...
        for(JAXBManager.Actual.Reflect ref :reflect)
        {
    ...
    public void addReflectList(List<JAXBManager.JAXBGenerated.Reflect> reflectorList) {
        for (JAXBManager.JAXBGenerated.Reflect JAXBReflect : reflectorList) {
