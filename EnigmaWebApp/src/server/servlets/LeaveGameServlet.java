...
public class LeaveGameServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //response.sendRedirect("/pages/games/gamelist");
        //response.sendRedirect("../games/gamelist.html");
        //response.setHeader("./gamelist.html");
        //response.setStatus(301);
        //response.setHeader("Location", "../games/gamelist.html");
